...
<footer class="page-footer">
	<div class="footer">
		<div class="esquerda_footer">
			...
			<div class="padfoter"><p class="contato_footer"><i class="fas fa-phone"></i>
			<?php echo get_theme_mod('cellphone_settings'); ?>
			<a href=https://api.whatsapp.com/send?phone=5519999156763&text=GrupoWZ-Site  target="_blank">
		...
		<div class="footer-copyright">
			<div class="container center">
				...
				<a href="http://byronsolutions.com" target="_blank" title="Site da byron.solutions">
					<img src="<?php echo get_template_directory_uri(); ?>/img/logo_byron.png" alt="Logo da byron.solutions" title="Logo da byron.solutions">
				</a>
			</div>
		</div>
